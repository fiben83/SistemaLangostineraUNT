  ...
  <%@include file="../jspf/navbar.jsp"  %>  
        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Crianza de Langostinos<small>Graficas de parametros y mediciones</small></h2>
                    ...
                    <div class="x_content">
                           ...
                           <div class="table-responsive">
                          		  <jsp:setProperty name="beanCrianza" property="tipoOper" value="P" /> <p>  
                               	  <jsp:getProperty name="beanCrianza" property="salida"/>
...
<!-- Modal reporte diario PDF -->
	...
	function show_parametros(id,t) {
		var idVar = id;
		var param=t;
		var url= 'http://localhost:8081/SistemaLangostineraUNT/GraficaParametros?idC='+idVar+'&crud='+param;
