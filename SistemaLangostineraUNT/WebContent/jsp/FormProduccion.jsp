  ...
  <%@include file="../jspf/navbar.jsp"  %>  
        ...
        <div class="right_col" role="main">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Reportes de Producción<small>Reportes y Consultas</small></h2>
                    ...
                    <div class="x_content">
                    	<ul class="nav navbar-right panel_toolbox">
                       		<li>
                       		 <h2><label>Seleccione por tipo de reporte</label></h2>
                       		</li>
                            <li>
                            	<select id="selectTipo" class="form-control" name="tipoR" required>
										<option value="-1">Seleccione..</option>
										<option value="annios">Por años</option>
										<option value="estanques">Por estanque</option>
										<option value="granjas">Por granja</option>
								</select>
							</li>
							<li>
                       		 <h2> <label>Año</label></h2>
                       		</li>
                            <li>
                            	<select id="selectAnnio2" class="form-control" name="annio2" required>
										<option value="-1">Seleccione..</option>
										<jsp:setProperty name="beanCrianza" property="tipoOper" value="A"/><p>
										<jsp:getProperty name="beanCrianza" property="salida" />
								</select>
							...
							<li>
								<button id="btnConsultar" class="btn btn-success"  onclick="consultar()">Consultar</button>
                            </li>
                         </ul>
                         	<div class="clearfix"></div>
                            <!-- Tabla de Mantenimiento -->
                           <div class="table-responsive">
                          		 <iframe id="frameProducion" width="100%" height="500px"></iframe>
...
<!-- Modal reporte diario PDF -->
	...
	function consultar() {
		...
		var t = $('#selectTipo option:selected').val();
		var a = $('#selectAnnio2 option:selected').val();
		var url= 'http://localhost:8081/SistemaLangostineraUNT/ReporteProduccion?annio='+a+'&tipo='+t;
	
      if(t==-1){
    	  alert("Seleccione tipo de reporte a consultar");
      }else{
    	   	if(t=='annios' && a==-1){
  				$('#frameProducion').attr('src',url);
  				...
  				if(t!=-1 && a!=-1){
  					...
  					if(t!='annios' && a==-1){
  						alert("Seleccione año para consultar");
  					}
  				}
