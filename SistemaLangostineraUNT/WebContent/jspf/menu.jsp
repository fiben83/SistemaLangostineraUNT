...
<%
	...
	String urlfoto="",foto="";  // Foto de la persona	
    ...
    if(auth_menu != null){
        ...
        urlfoto=persona.getUrlfoto();    //*** urlFoto de la persona
        foto="../dist/imagenes/usuarios/"+urlfoto;
        session_menu.setAttribute("urlfoto", urlfoto);
    	session_menu.setAttribute("foto", foto);
...
<div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
             <a href="../jsp/home.jsp" class="site_title"><img src="../dist/imagenes/logo0.jpg" width="30" height="30" class="img-circle" alt="">  <span>FIP-UNT</span></a>
          </div>
          <div class="clearfix"></div>
          <div class="profile">
            <div class="profile_pic">
                 <img src="../dist/imagenes/avatar.png" alt="" class='img-circle profile_img'> 
                  ...
                  <li><a><i class="fa fa-<% out.print(opciones.get(i).getIcono()); %>"></i> <span><% out.print(opciones.get(i).getNombre()); %></span> <span class="fa fa-chevron-down"></span></a>
                      ...
                      <% ArrayList<SubOpcion> subopciones = opciones.get(i).getSubopciones(); %>
                        <ul class="nav child_menu">
                            ...
                            <li><a href="<% out.print(subopciones.get(j).getUrl()); %>.jsp"   data-toggle= 'tooltip' data-placement="right" title= '<%= subopciones.get(j).getTooltip()%>'">
