 ...
 */
@WebServlet(name = "ReporteSemanal", urlPatterns = {"/ReporteSemanal"})
public class ReporteSemanal extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    	...
    	pathReporte=getServletContext().getRealPath("/report_mediciones_semanal.jasper");
       ...
       // JasperReport reporte= (JasperReport) JRLoader.loadObjectFromFile(getServletContext().getRealPath("WEB-INF/report_crianzas.jasper"));
    	...
    	if(tipo.equals("pdf")){
			...
			response.setHeader("Content-Disposition", "inline;filename=\"Reporte_Med_semanal.pdf\";");
			...
			response.setHeader("Content-Disposition", "attachment;filename=\"Reporte_Med_semanal.xls\";");
    		...
    		exporter.exportReport();
    		System.out.println("exportando xlsx");
    		}
